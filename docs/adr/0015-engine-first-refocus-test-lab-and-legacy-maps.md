...
- Items 4-5 are done without the full ADR 0010 crate split: `MatchSim` is renderer-free, but the server binary still links wgpu/alsa. Next: weapons and pick-up on the server, interest management, replay.
