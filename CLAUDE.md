...
- 27 integration test suites (`tests/`), 5 recipes (`recipes/`), 9 example maps (`examples/`); 38 ADRs (latest: 0038 reusable firearm arsenal and ads). Test *counts* are not stated here: run `scripts/dev test`.
<!-- facts:end -->
